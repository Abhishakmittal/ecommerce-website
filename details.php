														...
														<div id="products_box">
																...
																<?php
																	...
																	if(isset($_GET['pro_id'])){
																		...
																		$product_iddd= $_GET['pro_id'];

																$get_product_query= "SELECT * FROM Products where product_id='$product_iddd'";
															...
															while($row=mysqli_fetch_array($result))
															{
																...
																$prod_image2=$row['Product_img2'];
																$prod_image3=$row['Product_img3'];
																...
																<img src='admin_area/product_images/$prod_image2' width='180' height='180'/>
																<img src='admin_area/product_images/$prod_image3' width='180' height='180'/>
																<p>Rs.$prod_price</p>
																<br>
